...
var file_authentication_proto_rawDesc = string([]byte{
	...
	0x08, 0x0a, 0x06, 0x5f, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x2a, 0x45, 0x0a, 0x08, 0x41, 0x75, 0x74,
	...
	0x32, 0x83, 0x03, 0x0a, 0x15, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74,
	...
	0x6e, 0x52, 0x65, 0x73, 0x22, 0x00, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_authentication_proto_depIdxs = []int32{
	...
	11, // 1: pb.Auth.created_at:type_name -> google.protobuf.Timestamp
	11, // 2: pb.Auth.updated_at:type_name -> google.protobuf.Timestamp
	11, // 3: pb.Auth.deleted_at:type_name -> google.protobuf.Timestamp
	11, // 4: pb.Session.access_token_expires_at:type_name -> google.protobuf.Timestamp
	1,  // 5: pb.SignInRes.auth:type_name -> pb.Auth
	2,  // 6: pb.SignInRes.session:type_name -> pb.Session
	3,  // 7: pb.AuthenticationService.SignInWithEmail:input_type -> pb.SignInWithEmailReq
	4,  // 8: pb.AuthenticationService.SignInWithPhone:input_type -> pb.SignInWithPhoneReq
	5,  // 9: pb.AuthenticationService.SignInWithGoogle:input_type -> pb.SignInWithGoogleReq
	9,  // 10: pb.AuthenticationService.GetAuthById:input_type -> pb.GetAuthByIdReq
	10, // 11: pb.AuthenticationService.GetAuth:input_type -> pb.GetAuthReq
	7,  // 12: pb.AuthenticationService.RefreshToken:input_type -> pb.RefreshTokenReq
	8,  // 13: pb.AuthenticationService.LogOut:input_type -> pb.LogOutReq
	6,  // 14: pb.AuthenticationService.SignInWithEmail:output_type -> pb.SignInRes
	6,  // 15: pb.AuthenticationService.SignInWithPhone:output_type -> pb.SignInRes
	6,  // 16: pb.AuthenticationService.SignInWithGoogle:output_type -> pb.SignInRes
	1,  // 17: pb.AuthenticationService.GetAuthById:output_type -> pb.Auth
	1,  // 18: pb.AuthenticationService.GetAuth:output_type -> pb.Auth
	6,  // 19: pb.AuthenticationService.RefreshToken:output_type -> pb.SignInRes
	6,  // 20: pb.AuthenticationService.LogOut:output_type -> pb.SignInRes
